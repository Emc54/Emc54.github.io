...
simulation tests previously running on a PC in order to increase portability of the overall design.
...
and 100 Gbit/s links in access network. I developed algorithms in MATLAB for simulation of transceivers,
