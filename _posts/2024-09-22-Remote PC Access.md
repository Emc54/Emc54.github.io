...
There are many DDNS services, free and payed alike. I opted for
...
RpPi hostname from the dropdown menu.
...
specific settings for this usecase.
...
Some permission wrangling was in order as well before addding the configuration:
...
include a step of logging into my router and look up its IP everytime.
...
Both needed to be explicitely set, and likely uncommented if needed to actually
get it to work.
